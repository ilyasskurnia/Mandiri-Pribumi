...
<div class="container mt-5">
    ...
    <div class="row mt-3">
        <p style="text-align: center"> <span> <img style="max-height: 50px" src="{{URL::asset('/images/admin.png') }}" alt=""></span> Admin , 20 Oktober 2023</p>
    </div>
</div>
...
<div class="container mt-2">
    <div class="image">
        <img width="690" height="427" src="{{URL::asset('/images/artikel2.png') }}" alt="">
    </div>
    <div class="row mt-4">
