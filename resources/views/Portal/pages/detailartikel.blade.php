...
<section class="single">
    ...
    <div id="fh5co-title-box"
        style="background-image: url({{ asset('storage/' . $detail->thumbnail) }}); background-position: 50% 90.5px;"
            ...
            <div class="owl-carousel owl-theme" id="slider2">
                ...
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        <div class="fh5co_news_img"><img src="{{ asset('storage/' . $random->thumbnail) }}" alt="" />
                        </div>
                        <div>
                            <a href="/portal/{{ $random->id }}/detailartikel"
                                class="d-block fh5co_small_post_heading"><span class="">{{ $random->title }}</span></a>
                            <div class="c_g"><i class="fa-regular fa-calendar-days"></i>
                                {{ $random->created_at_formatted }}</div>
                        </div>
                    </div>
                </div>
                @endforeach
