...
<style>
  ...
  .konten {
    ...
    color: #000;
    box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2); /* Add shadow for floating effect */
    transition: 0.3s;
    margin: 10px;
    padding: 20px;
  }
  ...
  .konten:hover {
    box-shadow: 0 8px 16px 0 rgba(0, 0, 0, 0.2); /* Add a hover effect for more pronounced floating */
  }
    ...
    <div class="container mt-4">
      <div class="row justify-content-between konten">
        ...
        <div class="col-8 mt-3">
          ...
          <a href="{{ url('/portal/detailartikel') }}" class="btn btn-success mb-3" style="background-color: #2622DE; color: #fff;">SHOW MORE</a>
        </div>
      </div>
    </div>
  </div>
