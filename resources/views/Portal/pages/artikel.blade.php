          ...
          <div class="col-md-6 col-12 paddding animate-box" data-animate-effect="fadeIn">
              <div class="fh5co_suceefh5co_height"><img src="{{ asset('storage/' . $new->thumbnail) }}" alt="img" />
                  ...
                  <div class="fh5co_suceefh5co_height_position_absolute_font">
                      <div class=""><a style="text-decoration: none" class="color_fff"> <i class="fa-regular fa-calendar-days"></i>&nbsp;&nbsp;{{$new->created_at_formatted}}
                          </a></div>
                      <div class=""><a href="/portal/{{ $new->id }}/detailartikel" class="fh5co_good_font"> {{$new->title}} </a></div>
                  </div>
              </div>
          </div>
          @endforeach
              ...
              <div class="row">
                @foreach ($data['get_new2'] as $latest)
                  <div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
                      <div class="fh5co_suceefh5co_height_2"><img src="{{ asset('storage/' . $latest->thumbnail) }}" alt="img" />
                          <div class="fh5co_suceefh5co_height_position_absolute"></div>
                          <div class="fh5co_suceefh5co_height_position_absolute_font_2">
                              <div class="">
                                <a style="text-decoration: none" class="color_fff">
                                  <i class="fa-regular fa-calendar-days"></i>&nbsp;&nbsp;{{ $latest->created_at_formatted }}
                                </a>
                              </div>
                              <div class=""><a href="/portal/{{ $latest->id }}/detailartikel" class="fh5co_good_font_2"> {{$latest->title}} </a></div>
                          </div>
                      </div>
                  </div>
                @endforeach
          ...
          <div class="row mx-0">
              <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                  ...
                  <div class="row pb-4">
                      <div class="col-md-5">
                          <div class="fh5co_hover_news_img">
                              <div class="fh5co_news_img"><img src="{{ asset('storage/' . $artikel->thumbnail) }}" alt="" /></div>
                              <div></div>
                          </div>
                      </div>
                      <div class="col-md-7 animate-box">
                          <a href="/portal/{{ $artikel->id }}/detailartikel" class="fh5co_magna py-2"> {{ $artikel->title }} </a><br> <a
                              class="fh5co_mini_time py-3"> {{ $artikel->author }} -
              ...
              <div class="col-md-3 animate-box" data-animate-effect="fadeInRight">
                  ...
                  <div class="fh5co_tags_all">
                    @foreach ($data['get_kategori'] as $kategori)
                      <a href="/portal/kategoriartikel" class="fh5co_tagg">{{ $kategori }}</a>
                    @endforeach
                  </div>
              </div>
          </div>
