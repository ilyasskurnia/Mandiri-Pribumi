                    ...
                    <div id="add-data-paket" class="card">
                        ...
                        <div class="card-header pb-2">
                            <div class="d-flex align-items-center">
                                <h4 class="card-title">Edit Data Penawaran Spesial</h4>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="\dashboard\penawaran\{{ $data->id }}" method="post" enctype="multipart/form-data">
                                @method('put')
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="deskripsi" id="summernote" class="form-control" type="text"
                                                rows="10" cols="30">{!! $data->deskripsi !!}
                                            </textarea>
                                        </div>
                                    </div>
...
<script>
    $(document).ready(function() {
        $('#summernote').summernote({
            placeholder : 'Masukkan isi deskripsi anda disini',
            tabsize : 2,
            height : 350
        });
    });
