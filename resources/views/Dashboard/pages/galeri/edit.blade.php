            ...
            <section class="d-flex dlex-column gap-2 mt-4">
                <div class="page-inner" style="width: 100%">
                    <div id="add-data-paket" class="card">
                        ...
                        <div class="card-body">
                                <form action="\dashboard\galeri\{{ $data->id }}" method="post" enctype="multipart/form-data">
                                @method('put')
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="keterangan" class="form-control" type="text" >{{ $data->keterangan }}</textarea>
                                        </div>
                                </div>
