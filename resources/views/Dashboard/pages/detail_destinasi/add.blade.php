            ...
            <section class="d-flex dlex-column gap-2 mt-4">
                <div class="page-inner" style="width: 100%">
                    <div id="add-data-paket" class="card">
                        ...
                        <div class="card-body">
                                <form action="/dashboard/' . $destinasi->id . '/detail_destinasi/tambah_detail" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="form-control-label">destinasi_id</label>
                                            <input name="destinasi_id" class="form-control" type="text" value="{{ $destinasi->id }}">
                                        </div>
                                        <div class="form-group">
